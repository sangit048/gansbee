...
//   const [productsCount, ordersCount, vouchersCount, reviewsCount] =
//     await Promise.all([
...
// module.exports = app;
// app.js (Full content, with updates integrated - based on original provided, plus new admin routes for orders)
const express = require("express");
const mongoose = require("mongoose");
const dotenv = require("dotenv");
const morgan = require("morgan");
